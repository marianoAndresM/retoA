export default class ContPremios extends Phaser.GameObjects.Container {
  constructor(scene, x, y) {
    ...
    this.premiosTexto = this.scene.add.text(-200, 50, 'Premios: ', { font: '25px fuente', fill: '#fff' });
    this.premiosCantidad = this.scene.add.text(100, 50, this.scene.premios, { font: '25px fuente', fill: '#fff' } );
